...
if(loginCheck()){
  ...
  // TOTAL THREADS
  $threadSql = "SELECT * FROM posts";
  $threadResult = mysqli_query($conn, $threadSql);
  $threadResultCheck = mysqli_num_rows($threadResult);
  ...
  // TOTAL MESSAGES
  $messageSql = "SELECT * FROM msg";
  $messageResult = mysqli_query($conn, $messageSql);
  $messageResultCheck = mysqli_num_rows($messageResult);
...
<html>
  <head> 
    ...
    <title>Admin Panel - ForumJuve</title>
      ...
      <nav class="navbar navbar-expand-lg">
        ...
        <div class="container-fluid d-flex align-items-center justify-content-between">
          <div class="navbar-header">
            ...
            <!-- Log out               -->
            <div class="list-inline-item logout"><a id="logout" href="../inc/logout" class="nav-link"> <span class="d-none d-sm-inline">Logout </span><i class="icon-logout"></i></a></div>
          </div>
        </div>
      </nav>
    </header>
            ...
            <div class="row">
              <div class="col-md-3 col-sm-6">
                <div class="statistic-block block">
                  <div class="progress-details d-flex align-items-end justify-content-between">
                    <div class="title">
                      <div class="icon"><i class="icon-user-1"></i></div><strong>Utenti totali</strong>
                    </div>
                    <div class="number dashtext-1"><?php echo $totalResultCheck; ?></div>
                  </div>
              ...
              <div class="col-md-3 col-sm-6">
                <div class="statistic-block block">
                  <div class="progress-details d-flex align-items-end justify-content-between">
                    <div class="title">
                      <div class="icon"><i class="icon-contract"></i></div><strong>Thread totali</strong>
                    </div>
                    <div class="number dashtext-2"><?php echo $threadResultCheck; ?></div>
                  </div>
                  <div class="progress progress-template">
              ...
              <div class="col-md-3 col-sm-6">
                <div class="statistic-block block">
                  <div class="progress-details d-flex align-items-end justify-content-between">
                    <div class="title">
                      <div class="icon"><i class="icon-paper-and-pencil"></i></div><strong>Commenti totali</strong>
                    </div>
                    <div class="number dashtext-3"><?php echo $commentResultCheck; ?></div>
                  </div>
                  <div class="progress progress-template">
              ...
              <div class="col-md-3 col-sm-6">
                <div class="statistic-block block">
                  <div class="progress-details d-flex align-items-end justify-content-between">
                    <div class="title">
                      <div class="icon"><i class="icon-writing-whiteboard"></i></div><strong>Messaggi totali</strong>
                    </div>
                    <div class="number dashtext-4"><?php echo $messageResultCheck; ?></div>
                  </div>
                  <div class="progress progress-template">
