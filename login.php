...
<div class="container">
  <form action="inc/signin.php" method="POST" class="form-signin bg-light">
      <a href="index"><img class="mb-4" src="/forumjuve/img/logo-black.png" alt="" width="auto" height="72"></a>
      <?php loginErrors(); ?>
      <input type="text" id="username" class="form-control mb-1" name="username" placeholder="Username" required autofocus>
      <input type="password" id="password" name="password" class="form-control" placeholder="Password" required>
      <button class="btn btn-lg btn-secondary btn-block" type="submit" value="submit" name="submit">Login!</button>
