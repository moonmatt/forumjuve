    ...
    <div class="container">
                    ...
                    <div class="container">
                        ...
                        <form action="inc/profile.php" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="url" class="form-control" id="website_form" name="website_form"
      ...
      ?>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="city_form" name="city_form"
                                    value="<?php echo $city; ?>">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Data di nascita</label>
                                <input type="date" class="form-control" id="dofbirth_form" name="dofbirth_form"
                                    value="<?php echo $dofbirth; ?>">
                            </div>
                            <div class="form-group">
                                <label for="exampleFormControlTextarea1">Bio</label>
                                <textarea class="form-control" id="bio_form" name="bio_form"
                                    rows="5"><?php echo $bio; ?></textarea>
                            </div>
                            <button type="submit" class="btn btn-secondary" value="submit_profile"
